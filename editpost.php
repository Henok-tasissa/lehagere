<?php
	...
	if(!isset($_SESSION['user_id'])){
		...
		$postId = $_GET['pid'];
		$sql = "SELECT * FROM user_post WHERE user_id='$userId' AND post_id='$postId'";
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-lg-6">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="row">
								<form action="#" class="col-xs-12" id="updateForm" method="post">
									<div class="row">
									...
									<div class="row">
										...
										<div class="textarea-container">
											...
											<input class="col-xs-12" type="hidden" name="postId" id="postId">
											<input class="col-xs-12" type="hidden" name="userId" id="userId">
									...
									<div class="row">
											<div class="btn btn-success posted">Updated Successfully!</div>
											<div class="btn btn-danger deleted">Post deleted Successfully!</div>
											<div class="row">
												<div class="col-sx-4"></div>
												<button class="col-sx-4 btn btn-default postBtn" type="submit">Update</button>
												<button class="col-sx-4 btn btn-danger postBtn" id="deletePost" type="submit">Delete</button>
											</div>
									</div>
									<div class="row">
